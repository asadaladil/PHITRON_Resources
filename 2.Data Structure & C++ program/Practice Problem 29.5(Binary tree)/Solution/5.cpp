...
class Binary_Tree
{
    ...
    bool complete(node<Adil>*a)
    {
        if(perfect(a)==true||a==NULL)
        {
            return true;
        }
        int h=Height(a)-1,n=count_node(a);
        if(pow(2,h)<n)
        {
            return true;
        }
    ...
    bool full(node<Adil>*a)
    {
        if(a==NULL||perfect(a)==true)
        {
            return true;
        }
