...
#Method 1: concrete APIview(short cut)
...
class BookRetrieveUpdateDestroyAPIView(generics.RetrieveUpdateDestroyAPIView): # update, delete
    queryset = BookStoreModel.objects.all()
    serializer_class = BookStoreSerializer """
    
    
# Method 3: Short Cut/ Model view set
